...
func TestOnActionChange(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			i:           1,
			checked:     true,
			wantActions: map[string]map[string]bool{userB.UID: {p0: true}},
			wantClaims: map[string]map[string]bool{userA.UID: {p0: true},
		...
		},
		{
			...
			i:       1,
			checked: false,
			wantActions: map[string]map[string]bool{userB.UID: {p0: true, p1: false},
				userE.UID: {p1: false}},
			wantClaims: map[string]map[string]bool{userA.UID: {p0: true},
		...
		},
		{
			...
			i:       1,
			checked: false,
			wantActions: map[string]map[string]bool{userE.UID: {p1: false},
				userB.UID: {p1: false}},
			wantClaims: map[string]map[string]bool{userA.UID: {p0: true},
				userB.UID: {p1: false},
				userE.UID: {p0: true, p1: false}},
		},
		{
			...
			i:           2,
			checked:     true,
			wantActions: map[string]map[string]bool{userB.UID: {p1: false}},
			wantClaims: map[string]map[string]bool{userA.UID: {p0: true},
				userB.UID: {p1: false}, userE.UID: {p0: true}},
		},
		{
			name:    "cancel_b2",
			key:     p1,
			...
			checked: true,
			wantClaims: map[string]map[string]bool{userA.UID: {p0: true},
				userB.UID: {p1: true}, userE.UID: {p0: true, p1: true}},
		},
	}
